<?php  
  ...
  $session->set('html', '<h4 style="text-align: center; font-weight: bold; line-height: 26px;">EL GERENTE DE MERCADEO Y VENTAS DE <br> CONSUMER ELECTRONICS GROUP S.A.S <br><br>CERTIFICA</h4>
      <p style="line-height: 26px; text-align: justify;">Que el sr(a) <b>' . strtoupper($sql_usuario[0]['u_nombre1']) . ' ' . strtoupper($sql_usuario[0]['u_nombre2']) . ' ' . strtoupper($sql_usuario[0]['u_apellido1']) . ' ' . strtoupper($sql_usuario[0]['u_apellido2']) . '</b> identificado con número de cédula <b>' . number_format($sql_usuario[0]['u_nro_documento']) . ' </b> culminó y aprobó  exitosamente el curso ("' . $_REQUEST['curso'] . '")  de capacitación e inducción de la escuela de formación virtual Mandino.</p>
      ...
      <table style="padding-top: 10px;">
        <tr nobr="true">
          <td style="text-align: center;">
            <img src="'.$ruta_raiz.'img/certificados/firma_edgar.png">
            Edgard Augusto Lopez Gomez
            <br>
            <span style="font-size: 14px;">Gerente De Mercadeo</span>
          </td>
          <td></td>
          <td style="text-align: center;">
  ...
  $session->set('PDF_SAVE', 'Certificado ' . $_REQUEST['curso'] . '.pdf');
